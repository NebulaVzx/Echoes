...
### Phase 8: AI 陪伴建议
保存记忆后，AI 生成温情的、有建设性的反馈建议并持久化。支持文字/链接的不同建议策略，用户可开关控制。

### Phase 9: 标签重生
标签从静态附属品升级为可过滤、可管理、可发现的知识节点。包括标签过滤器、标签管理页（/tags）、标签云、标签颜色、关联发现。

### Phase 10: 记忆的温度
- **记忆 Streaks**：连续记录天数的温和鼓励
- **那年今日**：每天展示一条旧记忆，与过去的自己重逢
- **时间胶囊**：封印记忆到未来某个日期解锁
- **每日回顾**：今日记忆摘要卡片
